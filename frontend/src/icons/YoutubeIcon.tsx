export function YoutubeIcon() {
    return <svg className="size-6 hover:size-7 mt-1 mr-3 transition-all duration-200 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 25 25" fill="none">
